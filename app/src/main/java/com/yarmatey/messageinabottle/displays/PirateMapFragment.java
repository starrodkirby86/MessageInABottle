...
import com.yarmatey.messageinabottle.adapters.PirateMapAdapter;
 ...
 * Use the {@link PirateMapFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PirateMapFragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private RecyclerView mRecyclerView;
    public PirateMapAdapter mAdapter;
    private MapView mapView;
    private GoogleMap map;
    private CameraUpdate cameraUpdate;
    private HashMap<String, Marker> pirateMasts;

    public static PirateMapFragment newInstance() {
        PirateMapFragment fragment = new PirateMapFragment();
        return fragment;
    }

    public PirateMapFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_pirate_map, container, false);
        ...
        mAdapter = new PirateMapAdapter(getContext(), container, currentLocation, this);
...
//        }
    ...
    public void removeMarker(PirateMast mast) {
        pirateMasts.get(mast.getObjectId()).remove();
    }
...
//        markerOptions.position(new LatLng(mast.getPoint().getLatitude(), mast.getPoint().getLongitude()));
    ...
    public void newMast() {
        mAdapter.reload();
        ((Inventory) getActivity()).notifyUserMastsDataChange();
    }
    ...
    public void notifyChange(PirateMast mast) {
        mAdapter.reload();
        removeMarker(mast);
    }
}